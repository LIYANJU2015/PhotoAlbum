...
public class CheckRadioView extends AppCompatImageView {
    ...
    private void init() {
        selectedColor = ContextCompat.getColor(getContext(),  R.color.zhihu_item_checkCircle_backgroundColor);
        unSelectedColor = ContextCompat.getColor(getContext(), R.color.zhihu_check_original_radio_disable);
        setChecked(false);
    }
